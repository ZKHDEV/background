<template>
    <div id="sdk-upload-container">
        <el-button id="upload-btn" type="primary" :loading="isLoading">上传文件
...
export default {
    ...
    mounted() {
        ...
        this.uploader = Qiniu.uploader({
            ...
            container: 'sdk-upload-container',             // 上传区域 DOM ID，默认是 browser_button 的父元素，
            max_file_size: '100mb',             // 最大文件体积限制
            // flash_swf_url: '../static/Moxie.swf',  //引入 flash,相对路径
            max_retries: 3,                     // 上传失败最大重试次数
            dragdrop: true,                     // 开启可拖曳上传
            drop_element: 'sdk-upload-container',          // 拖曳上传区域元素的 ID，拖曳文件或文件夹后可触发上传
